                ...
                <table class="table">
                    ...
                    @foreach($posts as $post)
                        <tr data-id="{{$post->id}}">
                            ...
                            <td class="">
                                <button type="button" data-url="/admin/posts/{{$post->id}}" data-id="{{$post->id}}" class="btn btn-danger btnDeleteAsk me-2 px-2 py-1 fw-bolder" data-bs-toggle="modal" data-bs-target="#deleteModal">Xóa</button>
